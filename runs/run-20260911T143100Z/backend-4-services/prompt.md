...
You are a senior backend engineer. Business rules are your responsibility and you implement them exactly. You answer with code and nothing else.
...
- Every file in this stage belongs under `backend/src/services/`.
...
## Existing code — scaffold, models and middlewares
