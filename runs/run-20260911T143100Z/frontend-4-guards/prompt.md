...
You are a senior Angular engineer with a security focus. You answer with code and nothing else.
...
- Every file in this stage belongs under `frontend/src/app/`.
...
===== EXISTING FILE: frontend/src/environments/environment.production.ts =====
...
===== EXISTING FILE: frontend/src/environments/environment.ts =====
export const environment = {
  production: false,
  apiUrl: 'http://localhost:3000/api'
};
